...
post1 = Game(title='Game The First', name="G1", authors="Aryan")
post2 = Game(title='Game The Second', name="G1", authors="Simon")
post3 = Game(title='Game The Third', name="G1", authors="Serafino")
