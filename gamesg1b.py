...
def schritt3():
    ...
    return html_drumherum('''
        ...
        + antwort +'" angegeben. ' + kommentar_zur_antwort
        + '<p>Um diese Webseite zu sehen hat Ihr Browser einen HTTP "'
        + request.method + '''" request angefordert.</p>
...
def schritt4():
    ...
    if request.method == 'POST':
        ...
        return html_drumherum('''
            <h2>Hallo ''' + request.form['name'] + ''' (POST-request)</h2>
        ...
        return html_drumherum('<h2>Willkommen zu Schritt 4 (GET-request)</h2>'
            + formular)
# TODO: REMOVE
    #if request.method == 'POST':
...
def schritt5():
    ...
    return html_drumherum('''
        ...
        <ol><li>Die Debug-Version ihres Projekts ist
                ...
                <a href="''' + inf + '''">''' + inf + '''</a> abrufbar.
                Sie gibt im Bedarfsfall ausführliche Fehlermeldungen aus.</li>
            <li>Weitere HTML-Formular-Felder:
                <a href="''' + selfhtm + '''input/Radio-Buttons_und_Checkboxen">
                    Radio-Buttons und Checkboxen</a>,
                <a href="''' + selfhtm + '''Auswahllisten">
                    Auswahllisten</a> und
                <a href="''' + selfhtm + '''textarea">
                    textarea</a></li>
        </ol>''')
